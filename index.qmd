...
**Primary outcome**: composite CV event or death.
...
- Axis based decision use a single predictor to split data, creating decision boundaries that lie perpendicular to the axis of that predictor.
...
- Leo Breiman (2001) found oblique random forests compared more favorably to boosting than axis based ones

- Multiple benchmarks have found the same result. Oblique trees and oblique forests have higher prediction accuracy than their axis-based counterparts.

Yet, everyone is using axis-based random forests. **Why?**
...
Everyone is using axis-based random forests. Here's why
...
[Learn more about `aorsf`](https://docs.ropensci.org/aorsf/)
